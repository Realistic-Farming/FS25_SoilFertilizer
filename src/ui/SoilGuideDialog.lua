...
SoilGuideDialog.PAGE2 = {
    ...
    { t="B", v="Smart Sensor  — section control by need type." },
    { t="B", v="  Alt+1 Pest  •  Alt+2 Disease  •  Alt+3 Nutrient" },
    { t="B", v="See & Spray   — live cell pressure per section." },
    { t="B", v="  Alt+4 Pest  •  Alt+5 Disease  •  Alt+6 Weed" },
    { t="B", v="Variable Rate — auto boom rate from soil deficits." },
    { t="B", v="  Alt+7 to toggle on/off while in the sprayer." },
    { t="B", v="Enable each via Admin > Smart Systems in Settings." },
    { t="S", v=" " },
    { t="H", v="FREE PANEL LAYOUT" },
    { t="B", v="Enable in Settings > Display to drag each system" },
    { t="B", v="panel freely using the Shift+H edit mode." },
    { t="B", v="Press [-] in any title bar to collapse the panel." },
    { t="B", v="Positions and collapse state save automatically." },
}
...
SoilGuideDialog.PAGE5 = {
    ...
    { t="S", v=" " },
    { t="H", v="HOW DO I OPEN SETTINGS / ADMIN?" },
    { t="B", v="Press Shift+O anywhere in-game to open settings." },
    { t="B", v="The Admin tile (top-right on landing page) opens" },
    { t="B", v="the admin panel with Field Tools, Vehicle Tools," },
    { t="B", v="and the Smart Systems toggles page." },
}
