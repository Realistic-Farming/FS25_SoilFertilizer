...
MUTATIONS = [
 ...
 ("S4-owner-equality-restored", NE,
  ...
  "the first cut: a farm contracting for the owner is refused (Bob's blocker)"),
 ("S7-access-answer-ignored", NE,
  [("    local ok, allowed = pcall(handler.canFarmAccess, handler, farmId, vehicle)\n    return ok and allowed == true\n",
    "    local ok, allowed = pcall(handler.canFarmAccess, handler, farmId, vehicle)\n    return ok\n", 1)],
  "the engine's answer is asked and ignored: any player controls any vehicle"),
